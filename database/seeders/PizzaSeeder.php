...
class PizzaSeeder extends Seeder
{
    ...
    public function run()
    {
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/11970.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/buffalo-chicken-pizza.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/Chipotle-Chicken.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/chickenbruschetta.png')->url,
        ...
        Pizza::create([
            'name' => 'Chipotle Steak ',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/Chipotle-Steak.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/bacondblchburg.png')->url,
        ...
        Pizza::create([
            'name' => 'Classic Super ',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/12400.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/SausageMelt.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/bbqchicken.png')->url,
        ...
        Pizza::create([
            ...
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/12700.png')->url,
        ...
        Pizza::create([
            'name' => 'Sweet Heat',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/13830.png')->url,
        ...
        Pizza::create([
            'name' => 'Pepperoni',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/Pepperoni.png')->url,
        ...
        Pizza::create([
            'name' => 'Hot and Spicy',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/SHIS.png')->url,
        ...
        Pizza::create([
            'name' => 'Meat Supreme',
            'image_path' => Image::store('https://storage.pizzapizza.ca/phx2/ppl_images/products/en/2x/meat-supreme.png')->url,
